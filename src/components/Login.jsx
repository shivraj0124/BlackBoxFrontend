...
import { Eye, EyeOff, Lock, User, Code } from 'lucide-react';
                ...
                <div className="bg-gray-800/50 border border-green-500/20 rounded-xl p-8 backdrop-blur-sm">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {/* <div className="text-right">
                            <button type="button" className="cursor-pointer text-sm text-green-400 hover:text-green-300">
                                Forgot password?
                            </button>
                        </div> */}
                        ...
                        <button
                            type="submit"
                            className="w-full cursor-pointer bg-green-500 text-black font-bold py-3 rounded-lg hover:bg-green-400 transition-all transform hover:scale-105"
                        >
                            Login
                        </button>
                    </form>
